...
public class Villa extends AppCompatActivity {
   ...
   checkout data, use intent to connect Google Calendar and save the date/ booking */
    private void addToCalendar(){
        ...
        intent.putExtra(CalendarContract.Events.TITLE, "Hotel Booking - Villa Resort Hotel");  //the title that will reflect on the Google Calendar
        intent.putExtra(CalendarContract.Events.DESCRIPTION, "Stay at Villa Resort Hotel");
