...
public class RoyalPlaza extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_royal_plaza);
    ...
    private void addToCalendar(){
        ...
        * showing the booking dates are reflected on Google Calendar */
        ...
        intent.putExtra(CalendarContract.Events.TITLE, "Hotel Booking - Royal Plaza Hotel"); //the title that will reflect on the Google Calendar
        intent.putExtra(CalendarContract.Events.DESCRIPTION, "Stay at Royal Plaza Hotel");
...
* checkout date which opens the date picker control*/
    private void SelectDate(Button button){
        ...
        },2026, 3, 21); //this is the defaults date when the pop-up calendar is shown
